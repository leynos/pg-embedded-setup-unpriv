//! Asynchronous lifecycle management for embedded clusters.
...
impl TestCluster {
    ...
    async fn invoke_lifecycle_async(
        ...
        Box::pin(
            start_invoker.invoke(super::worker_operation::WorkerOperation::Start, async {
    ...
    async fn invoke_lifecycle_root_async(
        ...
        Box::pin(
            setup_invoker.invoke(super::worker_operation::WorkerOperation::Setup, async {
    ...
    fn stop_via_worker_sync(
        ...
        invoker
            .invoke_as_root(super::worker_operation::WorkerOperation::Stop)
