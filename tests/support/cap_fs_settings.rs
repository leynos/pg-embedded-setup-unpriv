//! Capability helpers used by the settings integration suite.
...
use pg_embedded_setup_unpriv::test_support::ambient_dir_and_path as shared_ambient_dir_and_path;
